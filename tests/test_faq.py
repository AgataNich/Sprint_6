...
class TestMainPageFaq:
    ...
    @allure.description('Проверяем, что при клике на вопрос открывается правильный ответ')
    @pytest.mark.parametrize( 'question_number, expected_answer', TestData.test_data_question_answer.items())
